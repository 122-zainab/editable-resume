...
window.addEventListener('load', () => {
    ...
    // img
    let resume_img = document.getElementById('resume_img');
    resume_img.src = img;
    let resume_mobile = document.getElementById('resume_mobile');
    resume_mobile.textContent = mobile;
    let resume_email = document.getElementById('resume_email');
    resume_email.textContent = email;
    let resume_add = document.getElementById('resume_add');
    resume_add.textContent = address;
    let resume_degree = document.getElementById('resume_degree');
    resume_degree.textContent = degree1;
    let resume_uni = document.getElementById('resume_uni');
    resume_uni.textContent = university;
    let passing_year = document.getElementById('passing_year');
    passing_year.textContent = pass1;
    let resume_degree2 = document.getElementById('resume_degree2');
    resume_degree2.textContent = degree2;
    let resume_colg = document.getElementById('resume_colg');
    resume_colg.textContent = colg;
    let passing_year2 = document.getElementById('passing_year2');
    passing_year2.textContent = pass2;
    let resume_degree3 = document.getElementById('resume_degree3');
    resume_degree3.textContent = degree3;
    let resume_school = document.getElementById('resume_school');
    resume_school.textContent = school;
    let resume_skill1 = document.getElementById('resume_skill1');
    resume_skill1.textContent = skill1;
    let resume_skill2 = document.getElementById('resume_skill2');
    resume_skill2.textContent = skill2;
    let resume_skill3 = document.getElementById('resume_skill3');
    resume_skill3.textContent = skill3;
    let resume_skill4 = document.getElementById('resume_skill4');
    resume_skill4.textContent = skill4;
    let resume_language1 = document.getElementById('resume_language1');
    resume_language1.textContent = language;
    let resume_language2 = document.getElementById('resume_language2');
    resume_language2.textContent = language2;
    let resume_objective = document.getElementById('resume_objective');
    ...
    let month_start = document.getElementById('month_start');
    month_start.textContent = starting_month;
    let year_start = document.getElementById('year_start');
    year_start.textContent = start_year;
    let resume_res1 = document.getElementById('resume_res1');
    resume_res1.textContent = responsibility1;
    let resume_res2 = document.getElementById('resume_res2');
    resume_res2.textContent = responsibility2;
    let resume_res3 = document.getElementById('resume_res3');
    resume_res3.textContent = responsibility3;
    let resume_res4 = document.getElementById('resume_res4');
    resume_res4.textContent = responsibility4;
    let resume_exp2 = document.getElementById('resume_exp2');
    resume_exp2.textContent = designation2;
    let month_start2 = document.getElementById('month_start2');
    month_start2.textContent = starting_month2;
    let year_start2 = document.getElementById('year_start2');
    ...
    let resume_res5 = document.getElementById('resume_res5');
    resume_res5.textContent = responsibility5;
    let resume_res6 = document.getElementById('resume_res6');
    resume_res6.textContent = responsibility6;
    let resume_res7 = document.getElementById('resume_res7');
    resume_res7.textContent = responsibility7;
    let resume_ref = document.getElementById('resume_ref');
